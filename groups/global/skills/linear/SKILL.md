...
{baseDir}/scripts/linear.sh issue <TEAM-123>   # Get issue details (incl. cycle)
{baseDir}/scripts/linear.sh branch <TEAM-123>  # Get branch name for GitHub

# Actions
{baseDir}/scripts/linear.sh create <TEAM_KEY> "Title" ["Description"] [--priority high] [--cycle current]
...
# Cycles
{baseDir}/scripts/linear.sh cycles [TEAM_KEY]                          # List all cycles
{baseDir}/scripts/linear.sh cycle <TEAM_KEY> [number|current]          # Issues in a cycle
{baseDir}/scripts/linear.sh cycle-create <TEAM_KEY> "Name" YYYY-MM-DD YYYY-MM-DD
{baseDir}/scripts/linear.sh cycle-add <TEAM-123> [TEAM_KEY] [number|current]
{baseDir}/scripts/linear.sh cycle-remove <TEAM-123>
