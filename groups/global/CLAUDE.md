...
|-------|------|-------------|
| meeting-processor | `skills/meeting-processor/SKILL.md` | Analyze a meeting transcript from the Supabase store, save structured summary back, post to #meeting-summaries, suggest Linear issues. Dashboard: https://fishbone-ai.github.io/meeting-insights/ |
